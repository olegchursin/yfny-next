            ...
            <div style={styles.timeline}>
                <Timeline mode="alternate" pending="В программе возможны изменения">
                    ...
                    <Timeline.Item
                        ...
                        <p>Посвящена популяризации русской культуры, традиций и языка и укреплению
                            связей с Россией.</p>
                    ...
                    <Timeline.Item
                        ...
                        <p>Презентации прошедших предварительный отбор молодежных проектов. Награждение
                            победителей молодежных проектов</p>
                    </Timeline.Item>
                    <Timeline.Item
                        dot={< Icon type = "clock-circle-o" style = {{ fontSize: '16px' }}/>}>
                        <p>19:30-21.00</p>
                        <h4>ЧАСТЬ ЧЕТВЕРТАЯ: ПРИЕМ ОТ ИМЕНИ ПОСЛА РФ В США АНАТОЛИЯ АНТОНОВА.</h4>
                        <p>Концерт Русского хора Йельского университета.</p>
                    </Timeline.Item>
                </Timeline>
            </div>
